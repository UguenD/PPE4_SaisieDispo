...
if ($result)
		echo "<meta http-equiv='refresh' content='0;url=index.php?message=<font color=green> Ajout realise... </font>'>";
else
		echo "<meta http-equiv='refresh' content='0;url=index.php?message=<font color=red> Probleme d`insertion... </font>'>";
