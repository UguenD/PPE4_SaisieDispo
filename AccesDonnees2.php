...
function afficheRequete($sql) {
	...
	echo "<table width=/400/ height=/10/ border=/1/ ><tbody>";
	
	
	echo $sql."<br/>";
	for ($i=0;$i<$nbchamps;$i++){
		echo nomChamp($sql, $i)."(".typeChamp($sql, $i).")";
	}
	echo "<br/>";
...
function afficheInfo($sql){
	
	echo "<table width=/200/ height=/10/ border=/1/><tbody>";
	
	echo "<th>".afficheRequete($sql)."</th>";
